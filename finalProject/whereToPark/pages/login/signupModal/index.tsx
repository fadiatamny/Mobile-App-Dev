...
import { View, Text, Modal, Linking, Platform, ImageBackground } from 'react-native';
...
const LoginModal = ({ setDisplay, navigation }: any): any => {
    ...
    const attemtSignup = async (username: string, password: string, name: string) => {
        try {
            ...
            const res: any = await Axios.post(`${ENDPOINT}/signup`, { username: username.toLowerCase(), password: password, name: name }, {
                headers: {
                    'API-KEY': API_KEY
                }
            });
        ...
        <View style={styles.centeredView}>
            <View style={styles.modalView}>
                ...
                <Button
                    ...
                    onPress={(): any => setTimeout(() => { attemtSignup(username, password, name); }, 500)}
                />
